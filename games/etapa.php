...
<title>GERADOR DE CÓDIGO PARA JOGOS  - WWW.P2MBRASIL.COM</title>
<style type="text/css">
.style1 {
	font-family: Verdana;
	font-size: 12px;
...
CATEGORIA: <font color="#FF0000">JOGOS</font><br>
P2MBRASIL.COM<br>
</b>
...
echo '<input type="hidden" name="historia" value="'.stripslashes(htmlspecialchars($historia)).'">';
...
echo "<input type='hidden' name='plataforma' value='$plataforma'>";
echo "<input type='hidden' name='console' value='$console'>";
