...
if($fabricante == "") { $fabricante="N/A"; }
if($ano == "") { $ano="N/A"; }
if($tipo == "Completo") { $tipo="<font color=red>Completo</font>"; }
if($historia == "") { $historia="<font color='#B0B0B0'><center>Indisponível</center></font>";}
if($descri == "") { $descri="<font color='#B0B0B0'><center>Indisponível</center></font>";}
if($requisitos == "") { $requisitos="<font color='#B0B0B0'><center>Indisponível</center></font>"; }
...
<tr bgcolor="#F4F6FB">
<td bgcolor="#F4F6FB"><div align="center"><strong>Gênero:</strong></div></td>
<td><div align="center"><?=stripslashes(htmlspecialchars($genero))?></div></td>
</tr>
<tr bgcolor="#F4F6FB">
<td bgcolor="#F4F6FB"><div align="center"><strong>Fabricante:</strong></div></td>
<td><div align="center"><?=stripslashes(htmlspecialchars($fabricante))?></div></td>
</tr>
<tr bgcolor="#F4F6FB">
<td bgcolor="#F4F6FB"><div align="center"><strong>Lançamento:</strong></div></td>
<td><div align="center"><?=stripslashes(htmlspecialchars($ano))?></div></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td background="http://www.p2mbrasil.com/forum/gerador/bkg2.jpg">História:</td>
</tr>
<tr>
<td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
<td bgcolor="#F4F6FB" scope="col" align="justify"><?=stripslashes(htmlspecialchars(nl2br($historia)))?></td>
</tr>
</table>
</td>
</tr>
...
<td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
<td bgcolor="#F4F6FB" scope="col" align="justify"><?=stripslashes(htmlspecialchars(nl2br($descri)))?></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td background="http://www.p2mbrasil.com/forum/gerador/bkg2.jpg">Requisitos de Sistema:</td>
</tr>
<tr>
<td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
<td bgcolor="#F4F6FB" scope="col"><?=stripslashes(htmlspecialchars(nl2br($requisitos)))?></td>
</tr>
</table>
</td>
</tr>
...
<td><div align='center'><strong>Tipo:</strong></div>
</td>
<td><div align='center'>$tipo</div>
</td>
</tr>";}
  if (($plataforma == "Rom") and ($console != "-------------------------------")){
  echo "<tr bgcolor='#F4F6FB'>
        <td><div align='center'><strong>Plataforma:</strong></div>
        </td>
        <td><div align='center'>$plataforma</div>
        </td>
        </tr>
        <tr bgcolor='#F4F6FB'>
        <td><div align='center'><strong>Console:</strong></div>
        </td>
        <td><div align='center'>$console</div>
        </td>
        </tr>";}
   else if ($plataforma == 'Rom'){
   echo "<tr bgcolor='#F4F6FB'>
         <td><div align='center'><strong>Plataforma:</strong></div>
         </td>
         <td><div align='center'>$plataforma</div>
         ...
         <td><div align='center'><font color='black'>Indefinido</font></div>
         </td>
         </tr>";}
      else{
      echo "<tr bgcolor='#F4F6FB'>
      ...
      if ($plataforma == 'PC'){
      echo "<tr bgcolor='#F4F6FB'>
      <td><div align='center'><strong>Sistema Operacional:</strong></div>
      </td>
      <td><div align='center'>";
      echo stripslashes(htmlspecialchars($os));
      echo "</div></td></tr>";}
?>
<tr bgcolor="#F4F6FB">
...
<tr bgcolor="#F4F6FB">
<td><div align="center"><strong>Número de Cds:</strong></div>
</td>
<td><div align="center"><?PHP echo $cds; ?></div>
</td>
</tr>
<tr bgcolor="#F4F6FB">
...
<tr>
<td background="http://www.p2mbrasil.com/forum/gerador/bkg2.jpg">Senha para o merge:</td>
</tr>
<tr>
<td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
...
$qtaP2M=0;
$compaP2M=(count($conta)/($cds));
$i2=0;

$qtaID=0;
$compaID=(count($conta1)/($cds));
$i4=0;

$qtaIDE=0;
$compaIDE=(count($conta2)/($cds));
$i6=0;
...
$idssenha=0;
    ...
    echo"
    <tr>
    <td background='http://www.p2mbrasil.com/forum/gerador/bkg2.jpg' class='style6'>Download CD$gtaP2M: (P2M)</td>
    </tr>
    <tr>
  ...
  if ($id > 0){
    ...
    echo"
    <tr>
    <td background='http://www.p2mbrasil.com/forum/gerador/bkg2.jpg' class='style6'>Download CD$gtaID: (ID)</td>
    </tr>
    <tr>
    <td bgcolor='#000000'><div align='center'>
    <table width='100%' border='0' cellspacing='1' cellpadding='0'>
  ...
  if ($ide > 0){
    ...
    echo"
    <tr>
    <td background='http://www.p2mbrasil.com/forum/gerador/bkg2.jpg' class='style6'>Download CD$gtaIDE: (IDS)</td>
    </tr>
    <tr>
    <td bgcolor='#000000'><div align='center'>
    <table width='100%' border='0' cellspacing='1' cellpadding='0'>
