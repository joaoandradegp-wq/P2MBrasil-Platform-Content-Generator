...
<title>GERADOR DE CÓDIGO PARA ANIMES  - WWW.P2MBRASIL.COM</title>
<style type="text/css">
.style1 {
	font-family: Verdana;
	font-size: 12px;
...
CATEGORIA: <font color="#FF0000">ANIMES</font><br>
P2MBRASIL.COM<br>
</b>
...
echo '<input type="hidden" name="saga" value="'.stripslashes(htmlspecialchars($saga)).'">';
echo '<input type="hidden" name="nomcap" value="'.stripslashes(htmlspecialchars($nomcap)).'">';
echo '<input type="hidden" name="episodio" value="'.stripslashes(htmlspecialchars($episodio)).'">';
