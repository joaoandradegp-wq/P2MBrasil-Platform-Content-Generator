...
<title>GERADOR DE CÓDIGO PARA SHOWS  - WWW.P2MBRASIL.COM</title>
<style type="text/css">
.style1 {
	font-family: Verdana;
	font-size: 12px;
...
CATEGORIA: <font color="#FF0000">SHOWS</font><br>
P2MBRASIL.COM<br>
</b>
...
echo '<input type="hidden" name="tituloshow" value="'.stripslashes(htmlspecialchars($tituloshow)).'">';
