...
<title>GERADOR DE CÓDIGO PARA OUTROS  - WWW.P2MBRASIL.COM</title>
<style type="text/css">
.style1 {
	font-family: Verdana;
	font-size: 12px;
...
CATEGORIA: <font color="#FF0000">OUTROS</font><br>
P2MBRASIL.COM<br>
</b>
...
echo '<input type="hidden" name="autor" value="'.stripslashes(htmlspecialchars($autor)).'">';
echo '<input type="hidden" name="formarquivos" value="'.stripslashes(htmlspecialchars($formarquivos)).'">';
echo '<input type="hidden" name="descricao" value="'.stripslashes(htmlspecialchars($descricao)).'">';
