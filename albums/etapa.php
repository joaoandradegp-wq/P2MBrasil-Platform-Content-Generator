...
<title>GERADOR DE CÓDIGO PARA FULL ALBUMS  - WWW.P2MBRASIL.COM</title>
<style type="text/css">
.style1 {
	font-family: Verdana;
	font-size: 12px;
...
CATEGORIA: <font color="#FF0000">FULL ALBUMS</font><br>
P2MBRASIL.COM<br>
</b>
...
echo '<input type="hidden" name="banda" value="'.stripslashes(htmlspecialchars($banda)).'">';
echo '<input type="hidden" name="album" value="'.stripslashes(htmlspecialchars($album)).'">';
echo '<input type="hidden" name="estilo" value="'.stripslashes(htmlspecialchars($estilo)).'">';
...
echo '<input type="hidden" name="qualidade" value="'.stripslashes(htmlspecialchars($qualidade)).'">';
echo '<input type="hidden" name="tempo" value="'.stripslashes(htmlspecialchars($tempo)).'">';
echo '<input type="hidden" name="musicas" value="'.stripslashes(htmlspecialchars($musicas)).'">';
...
echo '<input type="hidden" name="formarquivos" value="'.stripslashes(htmlspecialchars($formarquivos)).'">';
...
echo "<input type='hidden' name='formatocompacta' value='$formatocompacta'>";
