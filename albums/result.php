...
if($banda == "") { $banda="N/A"; }
if($album == "") { $album="N/A"; }
if($estilo == "") { $estilo="N/A"; }
if($tempo == "") { $tempo="N/A"; }
if($ano == "") { $ano="N/A"; }
if($qualidade == "") { $qualidade="N/A"; }
if($musicas == "") { $musicas="<font color='#B0B0B0'><center>Indisponível</center></font>"; }
...
?>
<center><span class="style1">CÓDIGO GERADO: <?=stripslashes(htmlspecialchars($banda))?></span>
...
<tr>
<td background="http://www.p2mbrasil.com/forum/gerador/bkg1.jpg" scope="col"><div align="center" class="style2" width="350" height="400">Capa</div></td>
</tr>
<tr><td valign="top" bgcolor="#F4F6FB"><div align="center">
<?php
if (($poster == "") or ($poster == "http://")) {
echo  "<img src='http://www.p2mbrasil.com/forum/gerador/shot.gif' width='350' height='400'>";
}
else {
echo "<img src='$poster' width='350' height='400'>";
}
?>
</div>
</td>
...
<div align="center">Banda:</div></th>
<td width="52%" scope="col">
<div align="center"><?=stripslashes(htmlspecialchars($banda))?></div></td>
</tr>
<tr bgcolor="#F4F6FB">
<td bgcolor="#F4F6FB"><div align="center"><strong>Nome do Álbum:</strong></div></td>
<td><div align="center"><?=stripslashes(htmlspecialchars($album))?></div></td>
</tr>
<tr bgcolor="#F4F6FB">
<td bgcolor="#F4F6FB"><div align="center"><strong>Estilo Musical:</strong></div></td>
<td><div align="center"><?=stripslashes(htmlspecialchars($estilo))?></div></td>
</tr>
<tr bgcolor="#F4F6FB">
<td bgcolor="#F4F6FB"><div align="center"><strong>Tempo de Duração:</strong></div></td>
<td><div align="center"><?=stripslashes(htmlspecialchars($tempo))?></div></td>
</tr>
<tr bgcolor="#F4F6FB">
...
<tr>
<td background="http://www.p2mbrasil.com/forum/gerador/bkg2.jpg">Músicas:</td>
</tr>
<tr>
<td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
<td bgcolor="#F4F6FB" scope="col"><?=stripslashes(htmlspecialchars(nl2br(($musicas))))?></td>
</tr>
</table>
</td>
</tr>
...
<tr bgcolor="#F4F6FB">
<td><div align="center"><strong>Qualidade:</strong></div>
</td>
<td><div align="center"><?=stripslashes(htmlspecialchars(($qualidade)))?></div>
</td>
</tr>
<tr bgcolor="#F4F6FB">
<td><div align="center"><strong>Formato dos Arquivos:</strong></div>
</td>
