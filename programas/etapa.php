...
<font face="Verdana">
<b>
GERADOR DE CÓDIGO PARA POSTS 2.0 Alpha <br>
...
echo '<input type="hidden" name="genero" value="'.stripslashes(htmlspecialchars($genero)).'">';
echo '<input type="hidden" name="fabricante" value="'.stripslashes(htmlspecialchars($fabricante)).'">';
echo '<input type="hidden" name="ano" value="'.stripslashes(htmlspecialchars($ano)).'">';
echo '<input type="hidden" name="site" value="'.stripslashes(htmlspecialchars($site)).'">';
echo '<input type="hidden" name="versao" value="'.stripslashes(htmlspecialchars($versao)).'">';
echo '<input type="hidden" name="versao_prog" value="'.stripslashes(htmlspecialchars($versao_prog)).'">';
echo '<input type="hidden" name="descri" value="'.stripslashes(htmlspecialchars($descri)).'">';
echo '<input type="hidden" name="requisitos" value="'.stripslashes(htmlspecialchars($requisitos)).'">';
...
echo '<input type="hidden" name="os" value="'.stripslashes(htmlspecialchars($os)).'">';
...
echo "<input type='hidden' name='cds' value='$cds'>";
...
if ($p2m > 0){
   ...
   echo "
       ...
       <tr>
         <td align='right' width='20%' class='style2'><b>CD 0$qtas:</b></td>
         <td>&nbsp;</td>
       </tr>";
