...
if($versao_prog == "") { $versao_prog="N/A"; }
...
<tr bgcolor="#F4F6FB">
<td bgcolor="#F4F6FB"><div align="center"><strong>Versão:</strong></div></td>
<td><div align="center"><?=stripslashes(htmlspecialchars($versao_prog))?></div></td>
</tr>
<tr bgcolor="#F4F6FB">
<td bgcolor="#F4F6FB"><div align="center"><strong>Ano:</strong></div></td>
<td><div align="center"><?=stripslashes(htmlspecialchars($ano))?></div></td>
</tr>
<tr bgcolor="#F4F6FB">
<td bgcolor="#F4F6FB"><div align="center"><strong>Site Oficial:</strong></div></td>
<td><div align="center">
<?PHP
  ...
  echo "N/A";
   ...
   echo "<a href='$site'>Clique aqui</a>";
   } ?>
</div></td>
</tr>
</table>
...
<td><div align="center"><?=stripslashes(htmlspecialchars($tamanho))?></div>
</td>
</tr>
<tr bgcolor="#F4F6FB">
